...
<fieldset>
<legend><h2>Headline Update</h2></legend>
<form name="frm" action="Headline_upd.jsp" method="post">
	...
	height:30px;
        ...
        <tr>
        <td>Headlines about:</td><td><input type="text" value="" id="txtHindiContent" name="headlineabout" style="height:20px; line-height:8px; width:200px" /></td>
        </tr>
        <tr>
        <td>Headlines :</td><td><input type="text" value="" id="txtHindiContent1" name="headline" style="height:20px; line-height:8px; width:200px"  /></td>
        </tr>
        <tr>
            <td>Description of Headline :</td>
