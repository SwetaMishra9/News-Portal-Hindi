...
<center><div style="border:0px solid #660033; height:180px; width:650px;">
<fieldset>
<legend><h2>Latest Photo Update</h2></legend>
<form name="form" method="post" enctype="multipart/form-data" action="main_img_upd.jsp"> 
    ...
    <tr><td colspan="2"><center>Upload image's height and width should be 390px and 590px</center></td></tr>
        ...
        <input type="file" name="file" style="height:20px; line-height:8px; width:200px"  /> </td>
        </tr>
