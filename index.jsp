...
<script type="text/javascript" src="js/subMenu_hindi.js"></script>
<script type="text/javascript" src="js/menuContents_hindi.js"></script>
...
<body>
<div style="max-width:1350px; min-height:35px; border:1px solid; background-image:url(images/templatmeo_body_top.jpg); background-repeat:repeat-x; background-position: right">
...
<a href="sampurn_kosi.html"><h3>व्यापार सुर्खियों में</h3></a>
    ...
    <div id="templatemo_content_wrapper" >
        ...
        <div style="height:460px; width:390px; float:left;">
...
<div id="sliderb_container" style="position: relative; width: 390px;
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; बिहार मसाला</h2>
                ...
                <div class="body" style="margin-top:10px">
                   ...
                   <a href="#"> <div style="height:120px;width:220px; float: left; margin-left:10px; border:1px solid" title="Update">
             ...
             आप अपनी पूरी क्षमता , एक शब्द में , मानव जाति को हासिल नहीं किया गया है कारण की पहचान करने के लिए , और हासिल होगा कभी नहीं किया था , तो उस शब्द ' बैठकों होगा |
              ...
              <div class="body" style="margin-top:10px;">
                   ...
                   <div style="height:100px; width:130px; float:left;background-image:url(images/images%20(4).jpg); margin-left:10px">
                    ...
                    <div style="height:100px; width:130px; float:left;background-image:url(images/images%20(4).jpg); border:1px solid ; margin-left:10px">
                    <img src="images/download (4).jpg" height="100px" width="130px" />
